			...
			<div class="floats">
				<div class="full-widget">		
					...
					<form class="form-4" action="" method="post">
						...
						Type: <select id="" name="ud_type" class="" required="">
							<option value="Vendor" <?php if($row['type'] == 'Vendor') { ?> selected="selected"<?php } ?>>Vendor</option> 
							<option value="Customer" <?php if($row['type'] == 'Customer') { ?> selected="selected"<?php } ?>>Customer</option>  
						</select>
